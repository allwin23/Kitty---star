...
export const DYNAMIC_IDLE_POOL: CatScenario[] = [
  {
    ...
    eventType: 'IdleTip1',
    tag: '[IDLE]',
    headline: 'You Pawsome Human! 🐾',
    subtext: 'Paws for a moment, stretch, and keep going! You got this!',
  ...
  },
  {
    ...
    eventType: 'IdleTip2',
    tag: '[IDLE]',
    headline: 'Believe in Your Pawsibility ✨',
    subtext: 'Small pawsitive steps every day create big progress!',
  ...
  },
  {
    ...
    eventType: 'IdleTip3',
    tag: '[IDLE]',
    headline: 'Stay Purr-sistent! 🐱',
    subtext: 'No hurdle is too big when you approach it with courage!',
  ...
  },
  {
    ...
    eventType: 'IdleTip4',
    tag: '[IDLE]',
    headline: 'Fur-tastic Progress! 🌟',
    subtext: 'Take a deep breath. You are doing much better than you think!',
    imageKey: 'ChatGPT Image Aug 1, 2026, 06_05_38 PM',
  },
  {
    id: 'idle-5',
    eventType: 'IdleTip5',
    tag: '[IDLE]',
    headline: 'Keep Reaching High! 🐾',
    subtext: 'Land on your feet with confidence today! Purr-fect effort!',
    imageKey: 'ChatGPT Image Aug 1, 2026, 06_05_38 PM',
  },
];
