      ...
      <View style={{ width: '100%', gap: spacing[24] }}>
        <Card style={{ gap: spacing[24], paddingVertical: spacing[32] }}>
          ...
          <View style={{ alignItems: 'center', gap: spacing[12] }}>
            <Link href="/(auth)/forgot-password" style={{ color: palette.cherryBloom, fontWeight: '600', fontSize: 14 }}>
              Forgot password?
            </Link>
            <Link href="/(auth)/signup" style={{ color: palette.textSecondary, fontWeight: '600', fontSize: 14 }}>
